...
function generateIDCard() {
  ...
  reader.onload = function () {
    ...
    document.getElementById("l2").innerHTML = `
      ...
      <h4 style="position: absolute; color:rgb(37, 11, 48); left:160px; z-index: 100; top:40px;">Name: ${name}</h4>
      <h4 style="position: absolute; color:rgb(37, 11, 48); left:160px; z-index: 100; top:100px;">College Name: ${college}</h4>
      <h4 style="position: absolute; color:rgb(37, 11, 48); left:160px; z-index: 100; top:160px;">Location: ${location}</h4>
    `;
  };
